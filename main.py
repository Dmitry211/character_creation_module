...
def start_training(character: Character) -> str:
    ...
    if character.__class__.__name__ in game_classes:
        print(f'{character.name}{game_classes[character.__class__.__name__]}')
...
def choice_char_class(char_name: str) -> Character:
    ...
    while approve_choice != 'y':
        selected_class: str = input('Введи название персонажа, за которого '
